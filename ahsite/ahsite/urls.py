...
urlpatterns = [url(r'^i18n/', include('django.conf.urls.i18n'))] + i18n_patterns(
    url(r'^$', views.home, name='home'),
    url(_(r'^quem-somos/$'), views.about_company, name='about_company'),
    url(_(r'^cotacoes-agricolas/$'), views.agricutural_prices, name='agricutural_prices'),
    url(_(r'^responsabilidade-ambiental/$'), views.environmental_responsability, name='environmental_responsability'),
    url(_(r'^responsabilidade-social/(?P<event_slug>.*)$'), views.event_view, name='event_view'),
    url(_(r'^compras/$'), views.sales, name='sales'),
    url(_(r'^vendas/(?P<product_slug>.*)$'), views.product_view, name='product_view'),
    url(_(r'^noticias/$'), views.news, name='news'),
    url(_(r'^noticias/(?P<news_slug>.*)$'), views.news_view, name='news_view'),
    url(_(r'^parcerias/(?P<partner_slug>.*)$'), views.partners_view, name='partners_view'),
